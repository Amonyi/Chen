...
-- Records of comments
-- ----------------------------
INSERT INTO `comments` VALUES ('44', '简墨', '2020-04-18 20:56:37', '这是测试数据', 'http://localhost:3000/src/images/uimg.jpg', '0', '1', '0', '0');
INSERT INTO `comments` VALUES ('45', '329472242@qq.com', '2020-04-18 20:57:35', '测试数据2', 'http://localhost:3000/src/images/uimg.jpg', '0', '1', '0', '0');
...
INSERT INTO `list_info` VALUES ('4', '探秘庇护之地：地下世界深处的秘密', '<p>迪亚波罗面对赫拉迪姆的追捕，东躲西藏了近十年，最后在坎杜拉斯的一处洞穴内被发现，赫拉迪姆与大魔神惊心动魄的大战就发生在这迷宫般的洞穴内。赫拉迪姆们只是执着于封印魔神们，也许还因为当时损失过大，却忽视了思考迪亚波罗是由于什么原因出现在坎杜拉斯地下深深的洞穴里的。</p><p>下图是世界之石被毁前的庇护之地地图，作为暗黑宇宙中的天堂、地狱以及庇护之地的位面位置，乃至三者之间的时空关系，未来咱们再做探讨。</p><img src=\"http://localhost:3000/src/images/4j1zki.jpg\" width=\"100%\"><P>探险家希拉丽雅通过长时间对庇护之地的探索观察，分析太阳的运行轨迹，得出了太阳照耀庇护之地运行的最高点就在崔斯特姆，而库拉斯特的位置刚好在东方太阳升起至最高点的1/4处，结合她之前对月亮轨迹的判断，认为太阳运行的最高处和月亮运行的最高处之交叉点，应该就是庇护之地世界的中心，这个地方就是崔斯特姆。<br>如此看来，迪亚波罗为何在此地的地下洞穴的探索行动应该有了一些解释。</p><p>原罪之战期间恶魔大军从庇护之地的地下洞穴蜂拥侵入庇护之地，这历史就连赫拉迪姆们都有所遗忘。迪亚波罗在庇护之地游荡，到处散布恐惧，热衷于寻找各类洞穴，应是计划再次打通地狱与庇护之地的连结。</p><img src=\"http://localhost:3000/src/images/75xuto.jpg\" width=\"100%\"><p>随着时间的流逝，庇护之地守护者塔格奥的力量与世界之石的联系日趋减弱，位面之间的联系在最薄弱之处时不时会出现漏洞。所幸米内瑞斯的后人们知晓这点，包括希拉丽雅，他们也一直在四处探索庇护之地上的这些薄弱之处。</p>', '2020-03-06 15:21:15', '30', '0', '10');
INSERT INTO `list_info` VALUES ('16', '探秘庇护之地：大教堂地下世界的秘密', '<p>暗黑起源里的崔斯特姆大教堂沿革，也是崔斯特姆的大教堂。在李奥瑞克成为坎杜拉斯王之后，大张旗鼓地在崔斯特姆原荒废修道院的基础之上修葺并添加了更多元素，使之成为了矗立在坎杜拉斯大地上最雄伟壮观的萨卡兰姆大教堂。</p><p>”我们听到过所有关于崔斯特瑞姆发生的怪异事件，不过听说他们从里面带出了成车的战利品，我们也想亲手试一试”他暂停下思考片刻，摸了摸左臂的残肢。“奇怪的是，为什么哪里有宝物，哪里就有怪物出来袭击你呢？ 为什么安全的地方就不会有什么收获呢？” 显然，一想起那段经历他就变得紧张起来，现在他正在试图让自己的情绪得以放松。</p><p>这是阿卜杜哈兹尔，庇护之地著名的学者、冒险家，在采访一位年长的冒险家，那位去过崔斯特姆大教堂地下世界寻宝的幸存者诉说的回忆。</p><p>从这位冒险者的回忆中，确实可以证实崔斯特姆萨卡兰姆大教堂的地下有着数不清的宝物，而且有不少人也从那个地下带出了成车的战利品，当然，代价也是很高昂的，这位冒险者失去了左臂，更多的冒险者失去了生命。迪卡德凯恩作为崔斯特姆的原住民，虽然中间外出探险，但是在暗黑时代又再次回到崔斯特姆大教堂。他也证实了地下有很多宝物。</p><img src=\"http://localhost:3000/src/images/16thumb.jpg\" width=\"100%\"><P>在他的日志里，也记录了有不少探险者去老教堂的地下寻宝的事情。而我们玩家在暗黑3里探险，除了会遇到被大主教拉扎鲁斯骗取做炮灰的死去村民遗体外，还有很多冒险者的遗体。<br>可见，崔斯特姆大教堂的地下世界确实有着数不清的宝物。而在暗黑起源的场景中，确实也有很多可见的宝物画面。</p><img src=\"http://localhost:3000/src/images/16cj.png\" width=\"100%\"><P>游戏中大教堂地下1-4层，有随处可见的华贵地毯，数不清的木桶，木桶里面可能会存放有宝物，也可能是发霉变质的补给，还有数量最多的书柜，这些书柜都很珍贵，被华丽的防尘柜帘保护着，里面有诸多珍贵的书籍，还有很多珍贵的瓶瓶罐罐，如果冒险者运气好，会发现大量的金币，或者是钻石首饰之类的宝物。</p>', '2020-03-23 14:27:00', null, null, null);
INSERT INTO `list_info` VALUES ('17', '把新星玩成小型奥陨—简析死灵新星组队速刷的操作', '<p>20赛季开始已有两周，经过这段时间的开发，新星死灵暂时成为了玩家们攻略四人天梯的首选，但在日常的组队中新星因为其较为独特的节奏和机制，很容易出现精英收不掉从而导致通关时间被拉长的情况，本帖中我将结合视频，详细为你描述新星死灵速刷时的节奏、操作，与其背后的机制原理。</p><span class=\"title2\"></span><p>老规矩，先来聊聊组队时容易造成新星死灵伤害波动的几个道具和机制。</p><img src=\"http://localhost:3000/src/images/17thumb.jpg\"><p>血潮利刃是我们最主要的增伤道具，它会根据我们身边的怪物大幅度的提升我们新星的伤害。</p><p>25码内20怪时，新星伤害提升1+（20*400）=81倍<br>25码内40怪时，新星伤害提升1+（40*400）=161倍<br>总之就是怪物越多新星伤害越高。</p><span class=\"title2\">节奏</span><p>用一句话概括新星死灵节奏：双黑奥陨出来之前火鸟奥陨的节奏。<br>虽然说通过合理的操作我们能最大化新星伤害从而做到打残精英甚至两个点打死，但在实战的过程中为了良好的节奏，有些精英是完全不用带的，死灵的元素12秒一轮，理想化的情况下，新星队伍在速刷时可以定小点，重复利用上文描述的神目操作秒杀中等数量的小怪，从而保证差图进度的领先，直到遇见好图，再根据情况进行精英的击杀。对了，很多野蛮人抱怨与死灵组队时的节奏太快，12秒一轮的元素实在让他分不出多少精力去带怪，甚至发展出了野蛮人拉怪死灵自己骨甲控制的速刷节奏，但实际上这是没必要的，死灵完全可以以12秒的倍数为周期进行战斗，比如说定点之后死灵先丢诅咒砍镰刀，野蛮人出去拉足24秒怪，毒元素回来踩一脚。当然，具体的情况还需要具体分析，蛮神也不是一天就能炼成的，多考虑队友多打配合才是组队的王道。</P><span class=\"title2\">怪物</span><P>对于新星死灵而言，部分传统意义上的好怪类型（比如虫群海、灵魂海、食腐兽海）更适合垫进度而不是收精英，因为这些怪物血量太低无法重复利用，相反的那些血多难缠的坏怪（比如蛇皮、红尸魔）反而是死灵较为喜欢的类型，只要数量足够就可以轻松用它们分批炸死精英。</p>', '2020-03-25 14:34:18', '0', '0', '33');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('2', '329472242@qq.com', '987654321', '2020-04-07 15:29:31', 'http://localhost:3000/src/images/rec-imgset4.jpg', '1', '0', '不会起名字', '3', '');
INSERT INTO `user` VALUES ('3', '763071532@qq.com', '123456789', '2020-04-07 16:29:34', 'http://localhost:3000/src/images/uimg.jpg', '1', '0', '763071532@qq.com', '3', null);
