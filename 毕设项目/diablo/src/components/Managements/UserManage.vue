      ...
      <div class="sj-top">
            ...
            <div class="search-box1"> 
                <div class="search1">
                   <el-row>
                      <el-col :span="12">
                        <el-input v-model="searchData"  placeholder="输入用户账号搜索" @blur="init"></el-input>
                      </el-col>
       ...
       <!-- 列表数据 -->
        <el-table :data="list" border>
            ...
            <el-table-column label="注册时间" prop="add_time" :show-overflow-tooltip="true">
       ...
       created() {
        ...
        methods: {
          ...
          handleClose(done) {
            ...
            seeInfo(id){
              this.seeDialog = true
              this.$http.get("getuser/"+id)
              .then(result=>{
                  this.listinfo.list_userName = result.body.userName
