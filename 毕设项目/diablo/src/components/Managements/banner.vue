      ...
      <div class="sj-top">
       ...
       <!-- 列表数据 -->
        <el-table :data="list" border>
            ...
            <el-table-column label="简介" prop="title" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column label="图片地址" prop="img_url" :show-overflow-tooltip="true"></el-table-column>
...
import { Modal } from 'ant-design-vue';
    ...
    //    修改
       putlistinfo(){
           if(this.listinfo.list_title == '' || this.listinfo.list_img == ''){
                this.flag=true
           }else{
                this.$http.put("editbanner",{
